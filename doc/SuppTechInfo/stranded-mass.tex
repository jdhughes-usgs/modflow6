...
The difference in the solute mass of the model between the two approaches (fig.~\ref{fig:strandedmassnosorption}\textit{B}) shows the effect more directly than the concentration does, because a concentration reflects both the mass in the cell and the volume of water that holds it. The difference alternates in sign with the water table. It is negative while the water table rises, reaching about $-38$ percent of the initial mass during the first rise, because the current approach saturates the interval as though it had held water at the concentration of the previous time step and creates mass. It is positive while the water table falls, reaching about 44 percent, because the current approach does not carry the solute of the retained water into the next time step and loses mass. The two do not cancel: at the end of the simulation the model that uses the option holds about 9 percent more of the initial mass than the model that does not, and the excursions within each cycle are several times larger than that net difference.

\begin{figure}[!ht]
	\begin{center}
	\includegraphics{./Figures/MSTStrandedMassNoSorption.pdf}
	\caption[Graphs comparing simulated concentrations with and without the stranded mass option, without sorption, for the oscillating water table example]{Graphs comparing simulated concentrations with and without the stranded mass option of the MST Package for the oscillating water table example shown in figure~\ref{fig:strandedmasshead}, without sorption and without decay. The cell has a mobile-domain porosity of 0.3, a specific yield of 0.15, and an initial concentration of 100 grams per cubic meter. \textit{A}, Simulated concentration; \textit{B}, difference in the solute mass of the model from the current approach, as a percentage of the initial mass; \textit{C}, mass held out of the mobile domain}
	\label{fig:strandedmassnosorption}
	\end{center}
\end{figure}

Adding sorption (fig.~\ref{fig:strandedmasssorption}\textit{A}) lowers the peak concentration to 146 grams per cubic meter, because sorbate buffers the dissolved concentration, and the option lowers it further to 100 grams per cubic meter, a reduction of 31 percent, because the sorbate that the cell gives up as it drains is held back along with the solute in the retained water. With first-order decay active, concentrations decrease from cycle to cycle as mass is lost from the simulation, and the concentration at the end of the simulation falls from 14.4 to 9.9 grams per cubic meter when the option is used. The mass held out of the mobile domain (fig.~\ref{fig:strandedmasssorption}\textit{C}) reaches about 6,780 kilograms in each cycle without decay, roughly twice the amount held back when only the retained water contributes, and decreases from cycle to cycle when decay is active, both because the concentration in the cell is lower and because the stranded mass decays while it is held. The difference in the solute mass of the model (fig.~\ref{fig:strandedmasssorption}\textit{B}) reaches 48 percent of the initial mass within a cycle with sorption and ends 12 percent higher than the current approach, because the sorbed mass that is held back adds to the solute of the retained water. With decay active the difference within a cycle is smaller, about 33 percent, and the net difference at the end of the simulation falls to 2 percent, because mass that is held out of the mobile domain decays while it is held and less of it survives to be returned.
