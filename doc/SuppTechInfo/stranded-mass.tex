...
Two quantities of solute are affected, and figure~\ref{fig:strandedmassconcept} shows what becomes of each of them. When the water table falls, the sorbate of the interval that drains is released to the water that remains, because the sorbed mass of a cell is scaled by the saturation, and the concentration rises. The solute in the water that is retained against drainage is treated differently: the volume of water in the mobile domain is taken as the saturation times the porosity, so the drained interval is treated as holding no water at all, and the solute that its retained water carries is no longer counted. When the water table rises again, the interval returns to the mobile domain without the solute it was holding, and the concentration is diluted.

\begin{figure}[!ht]
	\begin{center}
	\includegraphics{./Figures/MSTStrandedMassConcept.pdf}
	\caption[Diagrams showing what becomes of the solute of a cell whose water table moves]{Diagrams showing what becomes of the solute of a cell whose water table moves, without the stranded mass option. \textit{A}, The water table falls, the sorbate of the interval that drains is released to the water that remains, and the solute in the water retained in that interval is no longer counted; \textit{B}, the water table rises, and the interval returns to the mobile domain without the solute it was holding}
